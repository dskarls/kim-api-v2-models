                   ...
                   KIM_ModelComputeArguments const * const modelComputeArguments)
{
  ...
  C = &(buffer->C);
  Rzero = &(buffer->Rzero);
  logisticWidth = &(buffer->logisticWidth);
                        ...
                        KIM_TimeUnit const requestedTimeUnit)
{
  ...
  ier = fscanf(fid, "%s \n%lf \n%lf \n%lf \n%lf \n%lf",
              ...
              &logisticWidth, /* width of sigmoid in 1/Angstroms*/
  ...
  if(convertLength != ONE){
    ...
    a *= convertLength;
    C *= (1.0/convertLength);
    logisticWidth *= (1.0/convertLength);
  }
  ...
  buffer->logisticWidth = logisticWidth;
  ...
  KIM_ModelDriverCreate_SetParameterPointerDouble(modelDriverCreate, 1, &(buffer->logisticWidth), "logisticWidth");
